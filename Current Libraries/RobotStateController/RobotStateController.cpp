...
//TODO: All TIMING TODOS ARE ASSIGNED TO JORDAN
// I AM STILL FIXING TIMING SETTINGS
...
void RobotStateController::update() {
    ...
    if (currentState == FOLLOW_LINE) {
        ...
        Serial2.print(getStateName(currentState));
        Serial2.print(".");
        ...
        Serial2.println(getStateName(currentState));
        Serial.println(getStateName(currentState));
    }
    RobotState nextState = getNextState()->currState;
...
void RobotStateController::proceed() {
    ...
    robotCurrentState = getNextState();
    robotNextState = getNextState();
    update();
}

void RobotStateController::goBack() {
    robotNextState = robotCurrentState;
    robotCurrentState = getPrevState();
    robotPrevState = getPrevState();
    update();
}
